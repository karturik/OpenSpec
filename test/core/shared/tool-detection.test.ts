...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('openspec-propose-team');
      expect(SKILL_NAMES).toContain('openspec-explore-team');
      expect(SKILL_NAMES).toContain('openspec-apply-team');
      expect(SKILL_NAMES).toContain('openspec-verify-team');
    });
  });
